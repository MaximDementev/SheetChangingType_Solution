...
namespace KRGPMagic.Plugins.SheetChangingType.Commands.SecondChange
{
    [Transaction(TransactionMode.Manual)]
    [Regeneration(RegenerationOption.Manual)]
    public class SecondChangeCommand2 : IExternalCommand, IPlugin
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            return command.Execute(commandData, ChangeType.Second, 2);
        }
